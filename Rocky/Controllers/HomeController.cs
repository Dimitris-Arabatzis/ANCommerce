...
namespace Rocky.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            {
                Products = _prodRepo.GetAll(includeProperies:"Category,ApplicationType"),
        ...
        public IActionResult Details(int id)
        {
            ...
            {
                Product = _prodRepo.FirstOrDefault(u => u.Id == id,includeProperies: "Category,ApplicationType"),
                ExistsInCart = false
            };
